...
<![endif]-->
	...
	<script>
		...
		function permissionsDetail() {
			...
			$('#myfromMenu').panel(
					{
						href : '${pathSys}/project/role/permissions.action?role.id=${role.id }&role.roleName=${role.roleName}'
							+'&menu.id='+node.id+'&menu.text='+node.text+'&request=permissionsDetailPahe'
					});
		}
