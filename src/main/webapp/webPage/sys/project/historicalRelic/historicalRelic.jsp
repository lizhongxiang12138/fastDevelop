					...
					<div class="panel-body">
						<div>
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="historicalRelic.comUpTime" value="${historicalRelicModel.historicalRelic.comUpTime}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="historicalRelic.id" value="${historicalRelicModel.historicalRelic.id}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="historicalRelic.historicalTime" value="${historicalRelicModel.historicalRelic.historicalTime}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="historicalRelic.titleImageID" value="${historicalRelicModel.historicalRelic.titleImageID}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
						...
						<tbody>
							<c:forEach items="${page.item}" var="historicalRelic">
								<tr>
									...
									<td>${historicalRelic.id}</td>
									<td>${historicalRelic.intro}</td>
									<td>${historicalRelic.typeID}</td>
									<td>${historicalRelic.showTime}</td>
									<td>${historicalRelic.historicalTime}</td>
									<td>${historicalRelic.type}</td>
									<td>${historicalRelic.titleImageID}</td>
									<td>${historicalRelic.outlineDescribe}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
