...
<body>
	...
	<form:form id="dataForm" method="POST"
		...
		<div class="form-group col-sm-5" style="margin-top: 10px">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control easyui-validatebox"
					name="historicalRelic.historicalTime" data-options="required:true"
					validType="data_baseType"
					value="${historicalRelicModel.historicalRelic.historicalTime}">
			</div>
		</div>
		<div class="form-group col-sm-5" style="margin-top: 10px">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control easyui-validatebox"
					name="historicalRelic.comUpTime" data-options="required:true"
					validType="data_baseType"
					value="${historicalRelicModel.historicalRelic.comUpTime}">
			</div>
		</div>
		<div class="form-group col-sm-5" style="margin-top: 10px">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control easyui-validatebox"
					name="historicalRelic.type" data-options="required:true"
					validType="data_baseType"
					value="${historicalRelicModel.historicalRelic.type}">
			</div>
		</div>
		<div class="form-group col-sm-5" style="margin-top: 10px">
		...
		<div class="form-group col-sm-5" style="margin-top: 10px">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control easyui-validatebox"
					name="historicalRelic.showTime" data-options="required:true"
					validType="data_baseType"
					value="${historicalRelicModel.historicalRelic.showTime}">
			</div>
		</div>
		<div class="form-group col-sm-5" style="margin-top: 10px">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control easyui-validatebox"
					name="historicalRelic.outlineDescribe" data-options="required:true"
					validType="data_baseType"
					value="${historicalRelicModel.historicalRelic.outlineDescribe}">
			</div>
		</div>
		<div class="form-group col-sm-5" style="margin-top: 10px">
		...
		<div class="form-group col-sm-5" style="margin-top: 10px">
			...
			<div class="col-sm-4">
				...
				valueName="typeName" where="type=1"
		...
		<!-- S-文章内容 -->
		<div class="form-group" style="margin-top: 10px; width: 100%">
			<p style="text-align: center;font-weight: 700;font-size: 14px">文物介绍</p>
			<div style="width: 85%;margin: 2px auto;">
				...
				<script type="text/javascript"
					src="${path_page }/sys/project/historicalRelic/ueditor/ueditor.config.js"></script>
				<!-- 编辑器源码文件 -->
				<script type="text/javascript"
					src="${path_page }/sys/project/historicalRelic/ueditor/ueditor.all.js"></script>
				<!-- 实例化编辑器 -->
				<script type="text/javascript">
	...
	<p style="text-align: center;">
		...
		<button type="button"
			onclick="ajaxSubmit('#dataForm','${path}/sys/project/historicalRelic/save.action?historicalRelic.culturalRelicId=1');">保存</button>
	</p>
	<!-- E-提交按钮 -->
