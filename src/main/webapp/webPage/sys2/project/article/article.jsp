					...
					<div class="panel-body">
						<div>
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="article.titleSize" value="${articleModel.article.titleSize}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="article.hits" value="${articleModel.article.hits}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="article.recommend" value="${articleModel.article.recommend}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="article.toHref" value="${articleModel.article.toHref}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="article.titleColor" value="${articleModel.article.titleColor}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="article.remark" value="${articleModel.article.remark}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
							...
							<div class="form-group col-sm-4 ">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control"
										name="article.from" value="${articleModel.article.from}"
										placeholder="请输入">
								</div>
							</div>
							<div class="form-group col-sm-4 ">
						...
						<tbody>
							<c:forEach items="${page.item}" var="article">
								<tr>
									...
									<td>${article.toHref}</td>
									<td>${article.titleColor}</td>
									<td>${article.type}</td>
