...
<link href="css/bootstrap.min.css?v=3.3.5" rel="stylesheet" media="screen">
				...
				<script>
								...
								.ajax({
									...
									success : function(data) {
										...
										for (var i = 0; i < data.length; i++) {
											if (data[i].url == "#") {
												menu = '<li>'
														+ '<a><i class="fa fa-home"><span class="glyphicon glyphicon-floder-open">&nbsp;</span></i><span class="nav-label">'
														+ data[i].text
														+ '</span><span class="fa arrow"></span></a>';
											} else {
												menu = '<li>'
														+ '<a href="${path}'+data[i].url+'"><i class="fa fa-cutlery"></i> <span class="nav-label">'
														+ data[i].text
														+ '</span><span class="fa arrow"></span></a>';
											}
					...
					function setChildren(children) {
						...
						for (var j = 0; j < children.length; j++) {
							...
							if (children[j].url == "#") {
								menu += '<li><a class="J_menuItem">';
							} else {
								menu += '<li><a class="J_menuItem" href="${path}'+children[j].url+'" class="J_menuItem">';
							}
							if(child!=null){
								if(child.length>0){
									menu += '<i class="fa fa-home"></i><span class="nav-label">'
											+ children[j].text+'</span>'
											+'<span class="fa arrow"></span></a>';	
									menu += setChildren(child);
								}else{
									menu +='<span class="'+children[j].iconCls+'"></span><span class="nav-label">'
										+ children[j].text+'</span>'
										+'</a>';
								}
							}else{
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="index_v2.html?v=4.0" frameborder="0" data-id="index_v2.html"
					seamless></iframe>
			</div>
			<!-------------------------------------- 右侧主体部分 end------------------------------------------------------->
