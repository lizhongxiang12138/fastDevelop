...
public class OverridUtils {
     ...
     */
    public static void overridNotNull(Object obj1, Object obj2, Class clazz)
	    throws Exception {
	// 获取所有属性
	...
	for (int i = 0; i < fields.length; i++) {
	    ...
	    if(Modifier.isStatic(fields[i].getModifiers())) continue;//如果是静态变量
	    
	    // 通过get方法
	    Method getMethod = clazz
		    .getMethod("get" + fieldName.substring(0, 1).toUpperCase()
